    ...
    : QMainWindow(parent)
{
    //Image icon for username
        ...
        lab->move(100,50);
        QPixmap pixx("C:/Users/Sruthi/Desktop/use.png");
        ...
        QPixmap pix("C:/Users/Sruthi/Desktop/login.png");
        ...
        labb->move(100,110);
        QPixmap pixxx("C:/Users/Sruthi/Desktop/pwd.png");
        ...
        connect(button2,&QPushButton::clicked,[=](){
            if(unLineEdit->text() == "sruthi" && pwdLineEdit->text() == "159")
            {
